...
public class SwaggerHtmlBackendTest {
    ...
    public SwaggerHtmlBackendTest(final Resources resources, final String expectedOutput, final Map<String, String> options) {
        cut = new SwaggerHtmlBackend();
        cut.configure(options);
        this.resources = resources;
        this.expectedOutput = expectedOutput;

	    swaggerBackend = new SwaggerHtmlBackend();
    ...
    public void test() {
        ...
        final String swaggerOutput = new String(swaggerBackend.render(project));
