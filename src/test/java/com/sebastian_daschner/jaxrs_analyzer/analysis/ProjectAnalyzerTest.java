...
public class ProjectAnalyzerTest {
	...
	private static Resources getResources() {
		...
		final TypeIdentifier collectionOfGeneratedThings = TypeIdentifier.ofType("Ljava/util/Collection<Lcom/sebastian_daschner/jaxrs_test/GeneratedThing;>;");
		resources.getTypeRepresentations().put(collectionOfGeneratedThings, TypeRepresentation.ofCollection(collectionOfGeneratedThings, generatedRepresentation));
