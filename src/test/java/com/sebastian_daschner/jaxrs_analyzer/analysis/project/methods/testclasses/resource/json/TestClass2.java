...
public class TestClass2 {
    ...
    public static Set<HttpResponse> getResult() {
        ...
        jsonObject.getStructure().put("key", new Element(new Type("java.lang.String"), "value", "test"));
        jsonObject.getStructure().put("another", new Element(new Type("java.lang.String"), "value"));
