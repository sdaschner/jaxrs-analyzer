...
public class TestClass47 {
    ...
    public static Set<HttpResponse> getResult() {
        ...
        firstResult.getEntityTypes().add(new Type("java.util.List<com.sebastian_daschner.jaxrs_analyzer.analysis.project.methods.testclasses.resource.response.TestClass47$User>"));
