...
public class TestClass13 {
    ...
    public static Set<TypeRepresentation> expectedTypeRepresentations() {
        ...
        final TypeIdentifier longStringIdentifier = TypeIdentifier.ofType(new Type("com.sebastian_daschner.jaxrs_analyzer.analysis.results.testclasses.typeanalyzer.TestClass13$GenericFields<java.lang.Long,java.lang.String>"));
        final TypeIdentifier stringLongIdentifier = TypeIdentifier.ofType(new Type("com.sebastian_daschner.jaxrs_analyzer.analysis.results.testclasses.typeanalyzer.TestClass13$GenericFields<java.lang.String,java.lang.Long>"));
    ...
    public static TypeIdentifier expectedIdentifier() {
        return TypeIdentifier.ofType(new Type(TestClass13.class.getName()));
    }
